...
export enum GameEvent {
  ...
  SendNightTurnStart = 'send_night_turn_start',
  ReceiveNightTurnStart = 'receive_night_turn_start',
  ReceiveDayTurnStart = 'receive_day_turn_start',
  ...
  ReceiveNightTurnEnd = 'receive_turn_end',
